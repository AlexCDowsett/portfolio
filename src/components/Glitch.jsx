...
const GlitchEffect = ({ text, bgColor = null, textColor = null, glitchInterval = 35 }) => {
    ...
    useEffect(() => {
        ...
        }, glitchInterval * 0.4); // Make the character change interval proportional to glitchInterval

        return () => clearInterval(interval); // Clean up interval on unmount
    }, [isGlitching, index, text, bgColor, textColor, glitchInterval]); // Add glitchInterval to dependencies
    ...
    useEffect(() => {
        ...
        }, glitchInterval); // Use the glitchInterval parameter instead of hardcoded value

        return () => clearTimeout(timeout); // Clean up timeout on unmount
    }, [index, text, isGlitching, glitchInterval]); // Add glitchInterval to dependencies
